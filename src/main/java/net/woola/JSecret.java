...
public class JSecret {
    ...
    public static byte[] encrypt(byte[] text, PublicKey key) throws Exception
    {
        ...
        //
        // get an RSA cipher object and print the providerCodec
    ...
    public static byte[] decrypt(byte[] text, PrivateKey key) throws Exception
    {
        ...
        int startIndex = 0;
        int decryptMaxLength = 256;

        while (startIndex < text.length) {
            int endIndex = Math.min(text.length, startIndex + decryptMaxLength);
            byte[] temp = cipher.doFinal(Arrays.copyOfRange(text, startIndex, endIndex));
            dectyptedText = ArrayUtils.addAll(dectyptedText, temp);
            startIndex = endIndex;
        }
     ...
     * @throws java.lang.Exception
     */
    public static byte[] decrypt(String text, PrivateKey key) throws Exception
    {
        // decrypt the text using the private key
        return decrypt(decodeBASE64(text),key);
    }
